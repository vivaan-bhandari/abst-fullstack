...
if DEBUG:
    ...
    # Production CORS settings - more permissive for deployment
    CORS_ALLOW_ALL_ORIGINS = False
    CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS', default='https://abst-frontend.vercel.app,https://abst-frontend-git-main-vivaan-bhandari.vercel.app,https://abst-frontend.vercel.app,http://localhost:3000,https://localhost:3000,https://*.railway.app,https://*.vercel.app', cast=lambda v: [s.strip() for s in v.split(',')])
    # Allow credentials and common methods
    CORS_ALLOW_CREDENTIALS = True
    CORS_ALLOW_METHODS = ['GET', 'POST', 'PUT', 'PATCH', 'DELETE', 'OPTIONS']
    CORS_ALLOW_HEADERS = ['accept', 'accept-encoding', 'authorization', 'content-type', 'dnt', 'origin', 'user-agent', 'x-csrftoken', 'x-requested-with']
    CORS_EXPOSE_HEADERS = ['content-type', 'content-disposition']
